...
import { WEEKLY_LOG } from './data/weeklyLog'
...
const COACHING_SESSIONS: CoachSession[] = [
  ...
  { date: "2026-07-21", coach: "Teemu Lahdenpera", time: "11:00 AM" },
]
      ...
      <div style={{ padding: isMobile ? "22px 18px 24px" : "32px 36px 36px" }}>
        ...
        <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", flexWrap: "wrap" as const, gap: 10, marginBottom: 10 }}>
          ...
          <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
            <a href="/this-week.html" target="_blank" rel="noopener noreferrer" style={{ fontFamily: FONT, fontSize: 8.5, fontWeight: 800, letterSpacing: 1, textTransform: "uppercase" as const, color: INK2, background: "#fff", border: `1px solid ${RULE}`, padding: "4px 11px", borderRadius: 99, textDecoration: "none", display: "inline-flex", alignItems: "center", gap: 5 }}>
              Shareable link ↗
            </a>
            <span style={{ fontFamily: FONT, fontSize: 8.5, fontWeight: 800, letterSpacing: 1, textTransform: "uppercase" as const, background: "#FF1493", color: "#fff", padding: "4px 11px", borderRadius: 99 }}>
              Progress log
